...
- **Frontend**: Vue.js, Nuxt, React, Next.js, Angular, Tailwind CSS
...
- **Testing**: Vitest, Playwright, Go testing, coverage tooling

## Experience

- **[Astronautics Corporation of America](https://www.astronautics.com/)** (2025-Present):
  Software Engineer on the ground tools team, building a React application for interacting with the Flight Data Interface Management Unit (FDIMU).
...
- **[MaritzCX](https://www.linkedin.com/company/maritzcx/)** (2015-2016):
